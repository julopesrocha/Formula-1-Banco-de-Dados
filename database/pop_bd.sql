...
class f1:
    def __init__(self):
        self.constructors = pd.read_csv('csvs/constructors.csv')
        self.drivers = pd.read_csv('csvs/drivers.csv')
        self.circuits = pd.read_csv('csvs/circuits.csv')
        self.races = pd.read_csv('csvs/races.csv')
        self.results = pd.read_csv('csvs/results.csv')
